...
def WriteSettings():
    ...
    try:
        ...
        SettingsConfig.set(section, 'cameraSwitching', '3^80^18|0^10^10|1^5^8|4^2^5|7^1^5')
        SettingsConfig.set(section, 'firstLapSwitching', '3^1^10')
        SettingsConfig.set(section, 'pitCameraSwitching', '1^1^5|0^1^5|4^1^5')
        SettingsConfig.set(section, 'battleCams', '3^2^10|0^1^10|1^1^10')
                                ...
                                if gap < battleGap:
                                    ...
                                    if score > best_score:
                                        ...
                                        if tmpkmh1 > minPitKMH and tmpkmh2 > minPitKMH:
                                            # Using a realistic threshold for battleKMHPercentDiff
                                            if abs((tmpkmh1 - tmpkmh2) / tmpkmh1) * 100 < 50.0:
                                                best_score = score
                                                battleCar = car2
                                                bestBattleGap = gap
                                                kmh1 = tmpkmh1
